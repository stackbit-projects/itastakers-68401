                ...
                <div className="card__body">
                  <header className="card__header">
                    ...
                    {_.get(blog_feed_section, 'title', null) ? (
                      <h3 className="h4 card__title"><Link href={withPrefix(_.get(post, '__metadata.urlPath', null))}>{_.get(post, 'frontmatter.title', null)}</Link></h3>
                    ) : 
                      <h2 className="h4 card__title"><Link href={withPrefix(_.get(post, '__metadata.urlPath', null))}>{_.get(post, 'frontmatter.title', null)}</Link></h2>
                    }
                  </header>
                  ...
                  <footer className="card__footer">
                    {_.get(post, 'frontmatter.author', null) && ((() => {
                        ...
                        return (
                          author.link ? (
                            <span> go to Medium <Link href="{withPrefix(author.link)}{author.first_name} {author.last_name}"></Link></span>
                          ) : 
